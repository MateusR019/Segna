                  ...
                  <div className="flex items-center gap-2 min-w-0">
                    <span
                      className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                        t.type === "expense" ? "bg-[#ef4444]" : "bg-[#22c55e]"
                      }`}
                    />
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-[#6b7280]">Reservas e aportes</p>
        </div>
        <AddInvestmentDialog />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card className="bg-[#1a1a1a] border-[#2a2a2a]">
            ...
            <CardContent>
              ...
              <p className="text-xs text-[#6b7280] mt-1">{investments.length} investimento{investments.length !== 1 ? "s" : ""}</p>
            </CardContent>
          </Card>
        ...
        investments.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-[#4a4a4a] text-xs mt-1">
              Clique em &quot;Novo&quot; para adicionar sua primeira reserva
            </p>
          </div>
        ) : (
